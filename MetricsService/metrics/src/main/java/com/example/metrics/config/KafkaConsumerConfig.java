...
public class KafkaConsumerConfig {
    ...
    public ConsumerFactory<String, AuthEvent> consumerFactory() {
        ...
        configProps.put(ErrorHandlingDeserializer.VALUE_DESERIALIZER_CLASS, AuthEventDeserializer.class);
        configProps.put(JsonDeserializer.TRUSTED_PACKAGES, "*");
        configProps.put(JsonDeserializer.VALUE_DEFAULT_TYPE, AuthEvent.class);
